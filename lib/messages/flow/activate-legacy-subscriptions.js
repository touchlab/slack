...
module.exports = class ActivateLegacySubscriptions extends Message {
  ...
  toJSON() {
    ...
    Object.keys(this.subscriptions).forEach((key) => {
      ...
      this.subscriptions[key].forEach((subscription) => {
        attachment.fields.push({
          value: `/touchlab subscribe ${subscription.repoFullName}`,
        });
      });
    ...
    attachments.push({
      ...this.getBaseMessage(),
      mrkdwn_in: ['text'],
      text: '_Need help? Type "/touchlab help" or <https://get.slack.help/hc/en-us/articles/232289568-GitHub-for-Slack|learn more>._',
    });
